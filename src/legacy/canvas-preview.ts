...
async function mountPreview(host: HTMLElement, doc: AnimationDocument): Promise<void> {
...
export function showPreview(canvasEl: SVGSVGElement | null, def: AnimationDocument): void {
  if (!canvasEl) return;
