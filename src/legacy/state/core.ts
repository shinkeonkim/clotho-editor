...
export function setDraft(def: AnimationDocument): void {
  state.def = def;
  state.dirty = false;
  state.isDraft = true;
...
export function getDef(): AnimationDocument | null {
  return state.def;
}
...
export function setDef(def: AnimationDocument | null, markDirty = false): void {
  state.def = def;
